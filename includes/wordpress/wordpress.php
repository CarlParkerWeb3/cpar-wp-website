...
*/
     ...
     function cpar_wp_login_error_message( $error ) {
          ...
          return __( 'incorrect login', 'cpar-wp-website' );
...
*/
     ...
     add_action( 'admin_enqueue_scripts', 'cpar_wp_branding_dashboard_styles', 999999999 );

     function cpar_wp_branding_dashboard_styles() {
          ...
          return array_merge(
               ...
               $block_categories, array(
                    ...
                    array(
                         ...
                         'slug'    =>  'cpar-blocks',
                         'title'   =>  __( 'CPar Blocks', 'cpar-wp-website' )
...
*/
     ...
     function cpar_wp_patterns_category( ) {
          ...
          register_block_pattern_category(
               ...
               'cpar-synced-non',
               array( 'label' => __( 'CPar Non-Synced', 'cpar-wp-website' ) )
          ...
          register_block_pattern_category(
               ...
               'cpar-synced',
               array( 'label' => __( 'CPar Synced', 'cpar-wp-website' ) )
